...
import 'package:emall_app/EmallApp/models/ProductItemFeature.dart';
...
class ProductUtils{
  ...
  static singleProductItemOption(ProductItem productItem,ThemeData themeData, CustomAppTheme customAppTheme) {
    List<Widget> _list = [];
    List<ProductItemFeature> productItemFeatures = productItem.productItemFeatures;
