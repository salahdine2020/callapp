...
import 'package:emall_app/EmallApp/controllers/MaintenanceController.dart';
...
class MaintenanceScreen extends StatefulWidget {
  ...
  final String someInformation;

  const MaintenanceScreen(
      {Key key, this.isNeedUpdate = false, this.someInformation})
      : super(key: key);
...
class _MaintenanceScreenState extends State<MaintenanceScreen> {
  ...
  void initState() {
    ...
    print('GET IT SOME INFORMATION ${widget.someInformation} -------------');
  }
                            ...
                            ? Column(
                                children: [
                                  Container(
                                    ...
                                    child: Text(
                                      /// function get translate text from text in json
