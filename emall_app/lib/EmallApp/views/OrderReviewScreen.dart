...
import 'package:emall_app/EmallApp/controllers/DeliveryBoyReviewController.dart';
import 'package:emall_app/EmallApp/controllers/OrderController.dart';
import 'package:emall_app/EmallApp/controllers/ProductReviewController.dart';
import 'package:emall_app/EmallApp/controllers/ShopReviewController.dart';
...
import 'package:emall_app/EmallApp/utils/RatingWidget.dart';
...
class _OrderReviewScreenState extends State<OrderReviewScreen> {
  ...
  List<TextEditingController> productReviewTEControllers;
  ...
  _buildBody() {
    if (orderReview != null) {
      if (_dataExpansionPanel == null) {
        int totalReviews = orderReview.carts.length +
      ...
      return ExpansionPanelList(
        expandedHeaderPadding: Spacing.zero,
          ...
          child: Row(
            children: <Widget>[
              ClipRRect(
                ...
                child: orderReview.shop.imageUrl != null
                    ? Image.network(
                        orderReview.shop.imageUrl,
      ...
      children: [
        ...
        Container(
          ...
          child: validForReview
              ...
              : Text(
                  orderReview.deliveryBoyReview.review,
                  style: AppTheme.getTextStyle(themeData.textTheme.bodyText2,
                      color: themeData.colorScheme.onBackground),
                ),
        ),
                        ...
                        Text(
                          CurrencyApi.getSign(afterSpace: true) +
                              CurrencyApi.doubleToString(Product.getOfferedPrice(
                                  cart.productItem.price.toDouble(), cart.product.offer)),
                          style: AppTheme.getTextStyle(
...
class _CartProductDialog extends StatefulWidget {
  ...
  const _CartProductDialog({Key key, @required this.productItem, @required this.customAppTheme}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Dialog(
      ...
      child: Container(
        ...
        child: ProductUtils.singleProductItemOption(widget.productItem, themeData, widget.customAppTheme) ,
      ),
    );
  }
}
