...
class Cart {
  ...
  Cart(this.id, this.active,this.quantity, this.productId, this.productItemId, this.product, this.productItem);
  ...
  static Cart fromJson(Map<String, dynamic> jsonObject) {
    ...
    return Cart(id, active, quantity,productId, productItemId,product,productItem);
  }
