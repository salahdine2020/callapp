...
class ProductReview{
  ...
  ProductReview(this.id, this.rating, this.orderId, this.productId,this.productItemId, this.userId,
      this.review,this.createdAt,this.user);

  ProductReview.dummy(this.id, this.rating, this.orderId, this.productItemId, this.userId,
      this.review);
  ...
  static ProductReview fromJson(Map<String, dynamic> jsonObject) {
    ...
    return ProductReview(id, rating, orderId, productId,productItemId, userId, review,createdAt,user,);
  }
