...
class Product {
  ...
  static Product fromJson(Map<String, dynamic> jsonObject) {
    ...
    if (jsonObject['product_images'] != null)
      productImages = ProductImage.getListFromJson(jsonObject['product_images']);

    List<ProductReview> reviews;
    if(jsonObject['product_reviews']!=null)
      reviews = ProductReview.getListFromJson(jsonObject['product_reviews']);

    return Product(id, categoryId, shopId, name, description, rating, totalRating, offer, isFavorite, category, shop,productItems, productImages, reviews);
  }
