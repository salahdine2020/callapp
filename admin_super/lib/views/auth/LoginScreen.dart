...
class _LoginScreenState extends State<LoginScreen> {
  ...
  void initState() {
    ...
    isInProgress = false;
    emailTFController = TextEditingController(text: "manager@demo.com");
  ...
  initFCM() async {
    ...
    var token = await pushNotificationsManager.getToken();
    print('renew token suqence : $token -------------');
  }
                  ...
                  Container(
                      ...
                      child: Container(
                        ...
                        child: FlatButton(
                          ...
                          onPressed: () {
                            if (!isInProgress) {
                              /// means the app is in the first state
                              _handleLogin();
                            }
                          },
                          child: Stack(
