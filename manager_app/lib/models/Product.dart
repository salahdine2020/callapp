...
class Product {
  ...
  static Product fromJson(Map<String, dynamic> jsonObject) {
    ...
    int subCategoryId = int.parse(jsonObject['sub_category_id'].toString());
    ...
    return Product(id, subCategoryId, shopId, name, description, rating, totalRating, offer, isFavorite, category, shop,productItems, productImages, reviews);
  }
  ...
  @override
  String toString() {
    return 'Product{id: $id, subCategoryId: $subCategoryId, shopId: $shopId, name: $name, description: $description, rating: $rating, totalRating: $totalRating, offer: $offer, isFavorite: $isFavorite, category: $category, shop: $shop, productItems: $productItems, productImages: $productImages, reviews: $reviews}';
  }
